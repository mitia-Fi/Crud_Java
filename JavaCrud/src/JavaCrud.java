...
public class JavaCrud {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("Crud Examen Java");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				 ...
				 try {
				        pst = con.prepareStatement("insert into personne(nom,prenom,addresse,voiture)values(?,?,?,?)");
			...
			public void keyReleased(KeyEvent e) {
				  ...
				  try {
                      ...
                      String id = search.getText();
                          pst = con.prepareStatement("select nom,prenom,addresse,voiture from personne where id = ?");
                          pst.setString(1, id);
 ...
 String getNom,getPrenom,getAddresse,getVoiture,getSearch;
				 ...
				 try {
				        pst = con.prepareStatement("update personne set nom= ?,prenom= ?, addresse= ?, voiture= ? where id=?");
				        pst.setString(1, getNom);
				        pst.setString(2, getPrenom);
				        pst.setString(3, getAddresse);
				        pst.setString(4, getVoiture);
				        pst.setString(5, getSearch);
				        pst.executeUpdate();
